 ...
 *
 * -----------------------------------------------------------------------------
 *  $Id: PRCString.h,v 1.1 1996/12/11 13:59:29 collison Exp $
 * -----------------------------------------------------------------------------
 */
...
#include "booga/persistence/PExtra.h"     // operator<<(DataBase&, RCString&)
#include "booga/persistence/PersistenceFor.h"
