 ...
 *
 * -----------------------------------------------------------------------------
 *  $Id: ShaderWhileNode.h,v 1.4 1996/04/18 14:31:34 streit Exp $
 * -----------------------------------------------------------------------------
 */

#ifndef _ShaderWhileNode_H
#define _ShaderWhileNode_H

#include "booga/texture/ShaderNode.h"
#include "booga/texture/ShaderExpNode.h"

class ShaderWhileNode : public ShaderNode {

public:
  ShaderWhileNode(ShaderExpNode* theExp, ShaderNode* theStmt);
  virtual ~ShaderWhileNode();
