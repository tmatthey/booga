 ...
 * added #include "booga/glosmesa/context.h"
 *
 ...
 * a new gl_image struct.
 * Return NULL if there's an error during unpacking.
 * This function is often called by a higher-level unpack function such
