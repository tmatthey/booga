 ...
 *
 * -----------------------------------------------------------------------------
 *  $Id: RoofUser.h,v 1.3 1997/02/06 14:14:04 matthey Exp matthey $
 * -----------------------------------------------------------------------------
 */
...
class RoofUser : public Roof {
declareRTTI(RoofUser);
// enable RTTI support
...
public:
  RoofUser();
  RoofUser(Exemplar exemplar);
  RoofUser(const RoofUser& roofuser);      

public:
  virtual ~RoofUser();   
  
private:  
  RoofUser& operator=(const RoofUser& roofuser);  // No assignments.
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// New methods of class RoofUser
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
public:
...
inline Object3D* RoofUser::getObject() const 
{
  return myObject;
}
